    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/csm/reports" className="text-blue-600 hover:underline mt-4 inline-block">
            Back to Reports
          </Link>
        </div>
      </div>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href={`mailto:${report.citizen.email}`} className="text-blue-600 hover:underline">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={submitting}
                  className="w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-indigo-600 transition-all shadow-md disabled:opacity-50"
                >
